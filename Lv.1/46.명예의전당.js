...
function solution(k, score) {
  const answer = []; //정답
  const topScore = []; //명예의 전당

  for (i = 0; i < score.length; i++) {
    //k보다 작은 경우
    if (topScore.length < k) {
      topScore.push(score[i]);
    }
    //k보다 큰 경우
    else if (topScore.length >= k && score[i] >= Math.min(...topScore)) {
      topScore[topScore.length - 1] = score[i];
    }
...
const result1 = solution(3, [10, 100, 20, 150, 1, 100, 200]);
const result2 = solution(4, [0, 300, 40, 300, 20, 70, 150, 50, 500, 1000]);

console.log(result1); //[10, 10, 10, 20, 20, 100, 100]
